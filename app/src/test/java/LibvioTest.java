...
public class LibvioTest {
    ...
    public void detailContent() throws Exception {
        ...
        String content = spider.detailContent(Arrays.asList("714892085.html"));
