...
public class DianYingYunJiTest {
    ...
    public void categoryContent() throws Exception {
        String content = spider.categoryContent("https://dyyjpro.com/category/dianying", "2", true, null);
        JsonObject map = Json.safeObject(content);
        Gson gson = new GsonBuilder().setPrettyPrinting().create();
    ...
    public void detailContent() throws Exception {
        ...
        String content = spider.detailContent(Arrays.asList("https://dyyjpro.com/23023.html"));
