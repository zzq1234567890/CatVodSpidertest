...
import com.github.catvod.spider.YunPanZiYuan;
...
public class YunPanZiYuanTest {

    private Application mockContext;

    private YunPanZiYuan spider;

    @org.junit.Before
    public void setUp() throws Exception {
        mockContext = RuntimeEnvironment.application;
        Init.init(mockContext);
        spider = new YunPanZiYuan();
        Server.get().start();
    ...
    public void detailContent() throws Exception {
        ...
        String content = spider.detailContent(Arrays.asList("/Home/Detail/67ab0d07-f2be-2501-0004-272a6b8e2096"));
